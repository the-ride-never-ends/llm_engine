...
async def make_llama_cpp_async_api_call(
...
if __name__ == "__main__":
    ...
    response = loop.run_until_complete(
        make_llama_cpp_async_api_call(prompt=prompt, sampling_parameters=sampling_parameters)
    )
    ...
    chat_response = loop.run_until_complete(make_llama_cpp_async_api_call(messages=messages))
