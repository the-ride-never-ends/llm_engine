...
def convert_text_to_single_jsonl(txt_file_path, jsonl_file_path):
    """
    Convert a .txt file to a .jsonl file
    Useful if you want to train on the raw text first to give it broad knowledge, 
    then train on the Augmentoolkit or other dataset to teach it to answer questions on the subject
    Example:
